...
async function scrapeAvidii(): Promise<void> {
  ...
  try {
    ...
    // 2. Kurse scrapen (alte Kurse werden erst gelöscht, sobald der erste
    //    erfolgreiche Scrape neue Daten liefert - siehe unten. Verhindert,
    //    dass ein komplett fehlgeschlagener Lauf die Datenbank leer lässt.)
